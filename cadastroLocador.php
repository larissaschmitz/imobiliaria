...
<div class="container-fluid">
        ...
        <form method="post" action="acaoLocador.php">
            ...
            <label> ID </label>
                ...
                <input name="quantImoveis" id="quantImoveis" type="number" required="true" class="form-control" value="<?php if ($acao == "editar") echo $dados['quantImoveis']; ?>" placeholder="Digite a senha"><br>
<br><br>
