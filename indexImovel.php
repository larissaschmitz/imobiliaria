...
<br><br>
    ...
    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {   
        ...
        <tr><td><?php echo $linha['id'];?></td>
            ...
            <td><?php echo $linha['banheiros'];?></td>
            <td><?php echo $linha['endereco'];?></td>
            <td><a href='cadastroImovel.php?acao=editar&id=<?php echo $linha['id'];?>'> <img class="center" src="img/edit.png" alt=""></a></td>
            <td><?php echo " <a href=javascript:excluirRegistro('acaoImovel.php?acao=excluir&id={$linha['id']}')>Excluir Imóvel</a><br>"; ?></td>
